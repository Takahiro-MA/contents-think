# AI Co-Design Project: Operation Manual

このフォルダは、CLI型LLM（Claude Code / Gemini CLI）とのアプリ要件検討プロジェクト用のワークスペースです。
...
* 久しぶりに再開する場合は、`thinking-hub.md` の最下部にある **「9. Next Discussion Candidates」** を見てテーマを決めるとスムーズです。
